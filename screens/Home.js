...
const Home = ({navigation}) => {
    ...
    return (
        <View style={style.container}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('accueil')} style={style.button}><Ionicons name="language" color="#004d40" size={40}/><Text style={style.text}>Traduction          </Text><Image source={require('./../assets/traduction.png')} style={style.image}/></TouchableOpacity>
